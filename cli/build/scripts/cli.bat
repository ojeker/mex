...
set CLASSPATH=%APP_HOME%\lib\cli.jar;%APP_HOME%\lib\model.jar;%APP_HOME%\lib\slf4j-simple-1.7.36.jar;%APP_HOME%\lib\slf4j-api-1.7.36.jar


@rem Execute cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLI_OPTS%  -classpath "%CLASSPATH%" ch.jo.mex.cli.Main %*
